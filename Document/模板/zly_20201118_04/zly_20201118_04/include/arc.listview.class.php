...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".str_replace("{page}",$prepagenum,$tnamerule)."'><i class=\"iconfont\">&#xe660;</i></a>\r\n";
        ...
        {
            $nextpage.="<a href='".str_replace("{page}",$nextpagenum,$tnamerule)."'><i class=\"iconfont\">&#xe65f;</i></a>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<span class=\"number active\">$j</span>\r\n";
            }
            else
            {
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".$purl."PageNo=$prepagenum'><i class=\"iconfont\">&#xe660;</i></a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a href='".$purl."PageNo=$nextpagenum'><i class=\"iconfont\">&#xe65f;</i></a>\r\n";
