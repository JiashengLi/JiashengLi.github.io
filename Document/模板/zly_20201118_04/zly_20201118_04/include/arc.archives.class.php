    ...
    function GetPreNext($gtype='')
    {
        ...
        if(count($this->PreNext)<2)
        {
            ...
            if(is_array($preRow))
            {
                ...
                $this->PreNext['pre'] = "<a href='$mlink'><i class=\"iconfont\">&#xe660;</i><span>上一篇：</span>{$preRow['title']}</a> ";
            ...
            {
                $this->PreNext['pre'] = "<a><i class=\"iconfont\">&#xe660;</i><span>上一篇：</span>没有了</a> ";
            ...
            if(is_array($nextRow))
            {
                ...
                $this->PreNext['next'] = "<a href='$mlink'><i class=\"iconfont\">&#xe65f;</i><span>下一篇：</span>{$nextRow['title']}</a> ";
            ...
            {
                $this->PreNext['next'] = "<a><i class=\"iconfont\">&#xe65f;</i><span>上一篇：</span>没有了</a> ";
